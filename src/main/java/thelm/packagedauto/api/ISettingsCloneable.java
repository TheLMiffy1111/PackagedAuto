...
public interface ISettingsCloneable {
	...
	Result saveConfig(CompoundTag nbt, HolderLookup.Provider registries, Player player);

	Result loadConfig(CompoundTag nbt, HolderLookup.Provider registries, Player player);
